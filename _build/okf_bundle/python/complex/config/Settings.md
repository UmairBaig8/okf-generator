...
timestamp: '2026-07-02T18:42:21Z'
title: Settings
type: Class
---
...
- [config](/python/complex/config.md)
- [is_production](/python/complex/config/is_production.md)
- [is_currency_allowed](/python/complex/config/is_currency_allowed.md)
